...
Code to run Correlation Clustering:
```
spark-submit --master "local[*]" --class "final_project.main" target/scala-2.12/final_project_2.12-1.0.jar data/final_project_data/log_normal_100.csv data/log_normal_100_clustering_results.csv
```
